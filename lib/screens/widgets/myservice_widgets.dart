...
import 'package:portfolio/screens/widgets/text_widet.dart';
...
class _MyServicesWidgetState extends State<MyServicesWidget> {
        ...
        return MouseRegion(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: _isHovered[index] ? Colors.black12 : Colors.transparent,
              border: Border.all(
                color: _isHovered[index]
                    ? AppColors.studio.withOpacity(0.5)
                    : Colors.transparent,
            ...
            child: widget.size.width > 600
                ? _buildRowContent(index)
                : _buildColumnContent(index),
          ),
        );
      },
    );
  ...
  Widget _buildColumnContent(int index) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: [
        TextWidget(
